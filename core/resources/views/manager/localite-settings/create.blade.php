        ...
        <div class="col-lg-12 col-md-12 ntfcn-tab-content-left w-100 p-4 ">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-xs-12 col-sm-4">@lang('Select Village')</label>
                        <div class="col-xs-12 col-sm-8">
                    ...
                    <div class="form-group row">
                        <?php echo Form::label(__('Nom du Campement'), null, ['class' => 'control-label col-xs-12 col-sm-4']); ?>
                        <div class="col-xs-12 col-sm-8">
                            <?php echo Form::text('nom', null, ['placeholder' => __('Nom du Campement'), 'class' => 'form-control', 'required']); ?>
                        </div>
                    </div>
