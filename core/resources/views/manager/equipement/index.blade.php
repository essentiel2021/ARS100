...
@push('breadcrumb-plugins')
    ...
    <a href="{{ route('manager.traca.producteur.equipementcreate', encrypt($id)) }}" class="btn  btn-outline--primary box--shadow1  h-45"><i
                class="las la-plus"></i>@lang('Ajouter un matériel agricole')</a>
